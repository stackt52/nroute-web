...
function AddRetirementMiscellaneous({ handleRetireItem, setRetireItemClicked }) {
    const formik = useFormik({
        ...
        validationSchema,
        onSubmit: (values) => {
            const { amountSpent, description, comment, file } = values;
            const data = {
                _id: randomKey(),
                amountSpent,
                description,
...
AddRetirementMiscellaneous.propTypes = {
    handleAddItem: PropTypes.func,
    setAddItemClicked: PropTypes.func
};

export default AddRetirementMiscellaneous;